...
> 금 ETF과 리튬 ETF에 대해서는 다중공선성이 존재 하지 않는 것으로 확인.
...
-   위와 같은 결론으로 리튬 ETF의 경우 2020년 부터 발생한 주가 상승은 전가차의 급격한 수요에 의한 연관이 있을 것으로 예상되며 아직까지 전기차 수요가 다수를 차지 하지 않기 때문에 해당 주식에 대해서는 섣부른 투자는 하지 않는 것이 좋다고 사료됩니다.
